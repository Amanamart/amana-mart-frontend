...
import { Mail, Lock, Eye, EyeOff, ArrowRight, Github, Chrome, Facebook, ShieldCheck } from 'lucide-react';
          ...
          <div className="max-w-sm mx-auto w-full">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-1.5">
                <div className="flex items-center justify-between ml-1">
                  ...
                  <Link href="/forgot-password" weights="bold" className="text-[11px] font-bold text-[#008080] hover:underline">Forgot?</Link>
                </div>
                <div className="relative group">
            ...
            <div className="grid grid-cols-3 gap-3">
              {[
                ...
                { icon: Github, color: 'text-slate-800' }
              ].map((social, i) => (
                <button key={i} className="h-12 border border-slate-200 rounded-xl flex items-center justify-center hover:bg-slate-50 active:scale-95 transition-all">
