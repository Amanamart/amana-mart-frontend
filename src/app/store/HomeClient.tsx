...
import { Globe as ChevronLeft, Globe as ChevronRight, Globe as Star, Globe as ShoppingCart, Globe as Zap, Globe as ArrowRight, Globe as Clock, Globe as Store } from 'lucide-react';
  ...
  return (
    <div className="bg-white rounded-[var(--radius-lg)] border border-[var(--border)] overflow-hidden group cursor-pointer hover:shadow-[var(--shadow-md)] hover:-translate-y-0.5 transition-all duration-200">
      <div className="relative bg-[var(--muted)] h-40 flex items-center justify-center text-5xl">
        ...
        <button 
          className="absolute bottom-2 right-2 w-8 h-8 rounded-full bg-white shadow-md flex items-center justify-center text-[var(--foreground)] opacity-0 group-hover:opacity-100 hover:bg-[var(--primary)] hover:text-white transition-all"
          title="Add to cart"
        >
          ...
          <div className="grid grid-cols-4 sm:grid-cols-8 gap-3">
            {modules.map((mod) => (
              ...
              >
                <div
                  className={cn(
                    "w-12 h-12 rounded-[var(--radius-lg)] flex items-center justify-center text-2xl transition-transform duration-200 group-hover:scale-110",
                    mod.id === 'grocery' ? "bg-[#e8f9ee]" :
                    mod.id === 'pharmacy' ? "bg-[#fee2e2]" :
                    mod.id === 'food' ? "bg-[#fef3c7]" :
                    mod.id === 'electronics' ? "bg-[#dbeafe]" :
                    mod.id === 'fashion' ? "bg-[#ede9fe]" :
                    mod.id === 'home' ? "bg-[#cffafe]" :
                    mod.id === 'parcel' ? "bg-[#ffedd5]" : "bg-[#fce7f3]"
                  )}
                >
                  {mod.icon}
                </div>
        ...
        <section>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {topStores.map((store, i) => (
              ...
              >
                <div
                  className="w-14 h-14 rounded-[var(--radius-lg)] flex items-center justify-center text-3xl shrink-0 bg-[var(--muted)]"
                >
                  {store.emoji}
                </div>
